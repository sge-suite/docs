---
id: enums-e-migrations
title: Enums e migrations
description: Portal de compatibilidade para as referências separadas de enums e migrations do SGE.
type: documentation-hub
status: in-progress
visibility: public
tags: sge/desenvolvimento, sge/banco-de-dados, sge/planejamento
related: enums, migrations, backlog-e-decisoes, dominio-e-modelo-de-dados
source_refs:
---
...
- [Enums](doc:enums) — conjuntos fechados de valores e checklist de implementação.
- [Migrations](doc:migrations) — ordem, dependências, campos, FKs, índices e checklist de banco.
