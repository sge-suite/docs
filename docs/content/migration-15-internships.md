...
| `projected_end_date`               | data calculada pela carga horária do tipo, jornada semanal, feriados nacionais e estaduais da UF do campus e pausas.     |
...
- [ ] Validar regras do tipo, carga horária, período, feriados nacionais e estaduais aplicáveis e idade.
