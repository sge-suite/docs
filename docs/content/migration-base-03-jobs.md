---
id: migration-base-03-jobs
title: Migration base 03 — jobs
...
Jobs de e-mail devem combinar esta infraestrutura com [`email_delivery_attempts`](doc:migration-07-email-delivery-attempts), que é o histórico de negócio. `failed_jobs` sozinho não substitui o registro da tentativa nem deve receber segredos no payload/exceção.
