...
| Templates de documentos | `tests/Feature/DocumentTemplateTest.php` | Schema PostgreSQL sem `key`, FK e rollback, nomes repetidos permitidos, casts, scopes de campus e atividade, desativação e Activity Log. |
