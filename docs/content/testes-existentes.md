...
| Templates de documentos | `tests/Feature/DocumentTemplateTest.php` | Schema PostgreSQL, FK e rollback, chave única no escopo global ou do campus, casts, validação de `snake_case`, scopes de campus e atividade, desativação e Activity Log. |
