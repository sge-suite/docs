...
| Avaliações do supervisor | `tests/Feature/SupervisorEvaluationTest.php` | Schema PostgreSQL e rollback da Migration 18, FKs restritas, unicidade por estágio/supervisor, casts, rascunho, ramos condicionais do formulário, critérios, carga horária, análise, cancelamento, imutabilidade do envio, Activity Log e avaliação aprovada vigente. |
