...
status: defined
visibility: public
tags: sge/contexto, sge/documentacao
related: pessoas-e-responsabilidades, fluxos-principais, ciclos-de-status, glossario
source_refs:
...
Uma pessoa pode ter mais de uma atuação. No SGE, cada atuação é um **vínculo**: o contexto que define o papel da pessoa, o campus e, quando necessário, o curso em que ela está trabalhando. Para entender os papéis em detalhe, consulte [Pessoas e responsabilidades](doc:pessoas-e-responsabilidades).
...
- [Pessoas e responsabilidades](doc:pessoas-e-responsabilidades) para entender cada papel.
- [Fluxos principais](doc:fluxos-principais) para acompanhar as etapas do processo.
- [Ciclos de status](doc:ciclos-de-status) para saber o significado das situações do processo.
- [Glossário](doc:glossario) para consultar os termos usados na documentação.
